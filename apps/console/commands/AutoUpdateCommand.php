...
class AutoUpdateCommand extends ConsoleCommand
{
     ...
     * @return int
     */
    public function stdout($message, bool $timer = true, string $separator = PHP_EOL, bool $store = true)
    {
    ...
    protected function process()
    {
        ...
        $storage = (string)Yii::getPathOfAlias('common.runtime.auto-update');
        ...
        $command  = sprintf($command, $updateFolder . '/*', escapeshellarg((string)Yii::getPathOfAlias('root') . '/'));
        exec($command, $output, $status);
        ...
        $this->stdout('The files were copied successfully!');
