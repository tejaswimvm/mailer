...
var data_basic = {
    'snippets': [
		    ...
		    'html':
				'<div class="row">' +
					'<div class="column full padding-50" style="text-align: center;">' +
						...
						'<div class="spacer height-40"></div><span><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Contact Me</a></span>' +
					'</div>' +
				'</div>'
		},
		...
		*/
		...
		/* Audio */
		{
		'thumbnail': 'preview/element-html5audio.png',
		'category': '120',
		'html':
				'<div style="display:flex;width:100%;position:relative;margin:15px 0;background: transparent;"><audio controls="" style="width:100%">' +
        ...
        // Text Slider
        {
            'thumbnail': 'preview/element-slider-text.png', 'glide': true,
            'category': '120',
			'type': 'glide',
            'html':
                '<div class="row">' +
                    '<div class="column full is-dark-text" data-noedit data-module="text-slider" data-module-desc="Text Slider" data-dialog-width="1000px" data-dialog-height="570px" data-html="' +
	...
	
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Contact Us</a>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Shop Now</a>' +
					'</div>' +
				'</div>'
		},
       
        {
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Our Products</a>' +
					'</div>' +
				'</div>'
		},
				
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full right">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 text-black tracking-75 font-normal uppercase px-11 border-current hover:border-current rounded-full py-3">Browse Menu</a>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Get A Quote</a>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<div style="margin: 10px 0">' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 text-black tracking-75 font-normal uppercase px-11 border-current hover:border-current rounded-full py-3">All Products</a>' +
				        '\n</div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':				
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Contact Us</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded tracking-75 uppercase py-2 size-14 px-8 border-current text-black hover:border-current font-normal">Book a Consultation</a>' +
					'</div>' +
				'</div>'
		},
   
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">New Arrivals</a>' +
					'</div>' +
				'</div>'
		},
     
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full right">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Our Works</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full right">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 text-black tracking-75 font-normal uppercase px-11 border-current hover:border-current rounded-full py-3">Our Menu</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">View Portfolio</a>' +
					'</div>' +
				'</div>'
		},
    
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">View Collection</a>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<div class="center" style="margin: 15px 0">' +
							'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">View Destinations</a>' +
						'</div>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid mr-1 tracking-75 uppercase py-2 size-14 px-8 border-current rounded text-black hover:border-current font-normal ml-0">Contact Us</a></div>' +
					'</div>' +
				'</div>'
		},
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid mr-1 tracking-75 uppercase py-2 size-14 px-8 border-current rounded text-black hover:border-current font-normal ml-0">Get a Quote</a></div>' +
					'</div>' +
				'</div>'
		},
        ...
        
		{
		    ...
		    'html':
				'<div class="row">' +
					...
					'</div>' +
					'<div class="column third" style="display: flex; flex-direction: column; justify-content: flex-end; align-items: flex-start;">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row">' +
					...
					'</div>' +
					'<div class="column half" style="display: flex; flex-direction: column; justify-content: center; align-items: flex-end;">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row">' +
					'<div class="column half" style="display: flex; flex-direction: column; justify-content: center; align-items: flex-start;">' +
				...
				'<div class="row">' +
					...
					'<div class="column half">' +
						'<div style="padding-left: 40px">' +
							...
							_tabs(1) + '<div class="size-14 is-social">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<div style="text-align: center;">' +
							_tabs(1) + '<a href="#" role="button" class="is-btn" title="" style="margin: 3px 0px; display: inline-block; text-decoration: none; transition: all 0.16s ease 0s; border-style: solid; cursor: pointer; background-color: rgb(255, 76, 142); color: rgb(255, 255, 255); border-color: rgb(255, 76, 142); border-width: 2px; border-radius: 0px; padding: 10px 22px; line-height: 1.5; text-transform: uppercase; font-weight: 400; font-size: 11px; letter-spacing: 3px;" data-hover-bgcolor="#eb387a" data-hover-color="#ffffff" data-hover-bordercolor="#eb387a" onmouseover="this.setAttribute(\'data-style\',this.style.cssText);if(this.getAttribute(\'data-hover-bordercolor\')) this.style.borderColor=this.getAttribute(\'data-hover-bordercolor\');if(this.getAttribute(\'data-hover-bgcolor\')) this.style.backgroundColor=this.getAttribute(\'data-hover-bgcolor\');if(this.getAttribute(\'data-hover-color\')) this.style.color=this.getAttribute(\'data-hover-color\');" onmouseout="this.setAttribute(\'style\',this.getAttribute(\'data-style\'));this.removeAttribute(\'data-style\')">Portfolio</a> &nbsp; <a href="#" role="button" class="is-btn" title="" style="margin: 3px 0px; display: inline-block; text-decoration: none; transition: all 0.16s ease 0s; border-style: solid; cursor: pointer; background-color: rgb(23, 23, 23); color: rgb(255, 255, 255); border-color: rgb(23, 23, 23); border-width: 2px; border-radius: 0px; padding: 10px 22px; line-height: 1.5; text-transform: uppercase; font-weight: 400; font-size: 11px; letter-spacing: 3px;" data-hover-bgcolor="#ff4c8e" data-hover-color="#ffffff" data-hover-bordercolor="#ff4c8e" onmouseover="this.setAttribute(\'data-style\',this.style.cssText);if(this.getAttribute(\'data-hover-bordercolor\')) this.style.borderColor=this.getAttribute(\'data-hover-bordercolor\');if(this.getAttribute(\'data-hover-bgcolor\')) this.style.backgroundColor=this.getAttribute(\'data-hover-bgcolor\');if(this.getAttribute(\'data-hover-color\')) this.style.color=this.getAttribute(\'data-hover-color\');" onmouseout="this.setAttribute(\'style\',this.getAttribute(\'data-style\'));this.removeAttribute(\'data-style\')">Contact</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row">' +
					'<div class="column half">' +
						...
						'\n<div style="margin:1.2em 0">' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Buy Now</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						...
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;">' +
								...
								_tabs(2) + '<div style="margin:20px 0">' +
									_tabs(3) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Buy Now</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
				...
				'<div class="row">' +
					'<div class="column half">' +
						'<div style="padding-right: 40px">' +
							...
							_tabs(1) + '<div class="spacer height-20"></div>' +
							_tabs(1) + '<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Buy Now</a></div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				`<div class="row">
					<div class="column half"><img src="assets/minimalist-blocks/images/gaelle-marcel-jdxgmqjt1lu-unsplash-0N9uW1.jpg" alt=""></div>
					<div class="column half">
						<div style="padding-left: 10px;">
							...
							<div class="spacer height-20"></div>
							<p style="text-align: justify;">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
							<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 text-black tracking-75 font-normal uppercase px-6 py-2 size-12" title="">Add to Cart</a> &nbsp; <a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase px-6 py-2 size-12 border-current hover:border-current" title="">Buy Now</a></div>
							<div class="spacer height-20"></div>
				...
				'<div class="row">' +
					'<div class="column half">' +
						'<div style="padding-right: 10px;">' +
							...
							_tabs(1) + '<div><a href="#" role="button" class="is-btn" title="" style="margin: 3px 0px; display: inline-block; text-decoration: none; transition: all 0.16s ease 0s; border-style: solid; cursor: pointer; background-color: rgb(220, 220, 220); color: rgb(0, 0, 0); border-color: rgb(220, 220, 220); border-width: 2px; border-radius: 0px; padding: 10px 22px; line-height: 1.5; text-transform: uppercase; font-weight: 400; font-size: 12px; letter-spacing: 3px;">Add to Cart</a> &nbsp; <a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small" title="" style="padding: 10px 22px; font-size: 12px; line-height: 1.5;">Buy Now</a></div>' +
							_tabs(1) + '<div class="spacer height-20"></div>' +
		    ...
		    'html':
				'<div class="row">' +
					...
					'<div class="column half">' +
						...
						'\n<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.</p>' +
						'\n<div><a href="#" role="button" class="is-btn" title="" style="margin: 3px 0px; display: inline-block; text-decoration: none; transition: all 0.16s ease 0s; border-style: solid; cursor: pointer; background-color: rgb(220, 220, 220); color: rgb(0, 0, 0); border-color: rgb(220, 220, 220); border-width: 2px; border-radius: 0px; padding: 10px 22px; line-height: 1.5; text-transform: uppercase; font-weight: 400; font-size: 12px; letter-spacing: 3px;">Add to Cart</a> &nbsp; <a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small" title="" style="padding: 10px 22px; font-size: 12px; line-height: 1.5;">Buy Now</a></div>' +
						'\n<div class="spacer height-40"></div>' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
				'<div class="row">' +
					...
					'<div class="column half">' +
						...
						'\n<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard.</p>' +
						'\n<div><a href="#" role="button" class="is-btn" title="" style="margin: 3px 0px; display: inline-block; text-decoration: none; transition: all 0.16s ease 0s; border-style: solid; cursor: pointer; background-color: rgb(220, 220, 220); color: rgb(0, 0, 0); border-color: rgb(220, 220, 220); border-width: 2px; border-radius: 0px; padding: 10px 22px; line-height: 1.5; text-transform: uppercase; font-weight: 400; font-size: 11px; letter-spacing: 3px;">Add to Cart</a> &nbsp; <a href="#" role="button" class="is-btn" title="" style="margin: 3px 0px; display: inline-block; text-decoration: none; transition: all 0.16s ease 0s; border-style: solid; cursor: pointer; background-color: rgba(0, 0, 0, 0); color: rgb(23, 23, 23); border-color: rgb(23, 23, 23); border-width: 2px; border-radius: 0px; padding: 10px 22px; line-height: 1.5; text-transform: uppercase; font-weight: 400; font-size: 11px; letter-spacing: 3px;">Buy Now</a></div>' +
						'\n<div class="spacer height-20"></div>' +
					...
					<div class="column third">
						<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">
							<div style="padding:30px;width:100%;box-sizing:border-box;text-align:center;">
								...
								<p>Lorem Ipsum is dummy text of the printing industry.</p>
								<div style="margin:1.2em 0">
									<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Select Plan</a>
								</div>
							</div>
						</div>
					</div>
					<div class="column third">
						<div class="is-card is-light-text shadow-1" style="width:calc(100%);background-color: #27ae60">
							<div style="padding:30px;width:100%;box-sizing:border-box;text-align:center;">
								...
								<p>Lorem Ipsum is dummy text of the printing industry.</p>
								<div style="margin:1.2em 0">
									<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current" style="color: rgb(255, 255, 255);">Select Plan</a>
								</div>
							</div>
						</div>
					</div>
				...
				'<div class="row">' +
					'<div class="column third">' +
						...
						'\n<div style="margin:1.5em 0">' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Get Started</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
					...
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<p>Lorem Ipsum is dummy text of the printing industry.</p>' +
								_tabs(2) + '<div style="margin:1.2em 0">' +
									_tabs(3) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Purchase</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					...
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<div style="margin:1.2em 0">' +
									_tabs(3) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Select Plan</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column half">' +
						...
						'\n<div style="margin:1.2em 0">' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Select Plan</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row">' +
					'<div class="column third">' +
						...
						'\n<div style="margin:2em 0 1em">' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Buy Now</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
				...
				'<div class="row">' +
					'<div class="column half">' +
						...
						'\n<div style="margin:2em 0">' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Choose Plan</a>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<h3>PREMIUM</h3>' +
						...
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<div style="margin:1.5em 0">' +
									_tabs(3) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Choose Plan</a>' +
								_tabs(2) + '</div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					...
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Get Started</a></div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
...

		{
			...
			<div class="row">
				<div class="column third flex flex-col justify-center items-center">
					<div class="flex flex-col justify-center items-center" style="width: 120px;height: 120px;border-radius: 50%;border: 3px solid #333;">
						<p class="size-32 font-bold">80%</p>
					</div>
					<p>DESIGN</p>
				</div>
				<div class="column third flex flex-col justify-center items-center">
					<div class="flex flex-col justify-center items-center" style="width: 120px;height: 120px;border-radius: 50%;border: 3px solid #333;">
						<p class="size-32 font-bold">75%</p>
					</div>
					<p>MARKETING</p>
				</div>
				<div class="column third flex flex-col justify-center items-center">
					<div class="flex flex-col justify-center items-center" style="width: 120px;height: 120px;border-radius: 50%;border: 3px solid #333;">
						<p class="size-32 font-bold">92%</p>
					</div>
					<p>DEVELOPMENT</p>
				</div>
			</div>
				...
				<div class="row">
					<div class="column fourth flex flex-col justify-center items-center">
						<div class="flex flex-col justify-center items-center" style="width: 100px;height: 100px;border-radius: 50%;border: 3px solid #333;">
							<p class="size-32 font-bold">90%</p>
						</div>
						<p>WEB DESIGN</p>
					</div>
					<div class="column fourth flex flex-col justify-center items-center">
						<div class="flex flex-col justify-center items-center" style="width: 100px;height: 100px;border-radius: 50%;border: 3px solid #333;">
							<p class="size-32 font-bold">78%</p>
						</div>
						<p>GRAPHIC DESIGN</p>
					</div>
					<div class="column fourth flex flex-col justify-center items-center">
						<div class="flex flex-col justify-center items-center" style="width: 100px;height: 100px;border-radius: 50%;border: 3px solid #333;">
							<p class="size-32 font-bold">70%</p>
						</div>
						<p>PHOTOGRAPHY</p>
					</div>
					<div class="column fourth flex flex-col justify-center items-center">
						<div class="flex flex-col justify-center items-center" style="width: 100px;height: 100px;border-radius: 50%;border: 3px solid #333;">
							<p class="size-32 font-bold">82%</p>
						</div>
						<p>MARKETING</p>
					</div>
				</div>			
...

		{
		    ...
		    'html':
				...
				'</div>' +
				'<div class="row">' +
					'<div class="column sixth" style="background-color: rgb(250, 250, 250);">' +
						'<h1 class="size-46" style="line-height: 2.5; text-align: center; font-family: courier;">90%</h1>' +
					'</div>' +
					'<div class="column two-sixth" style="background-color: rgb(250, 250, 250);">' +
...

		{
		    ...
		    'html':
		    	'<div class="row">' +
					...
					'</div>' +
					'<div class="column half" style="display: flex; flex-direction: column; justify-content: flex-end; align-items: center;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Homepage</a>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row">' +
					'<div class="column full center">' +
						...
						'\n<div style="margin: 35px 0">' +
							_tabs(1) + '<a href="#" class="is-btn is-btn-ghost2 is-upper is-btn-small">Contact Us</a> &nbsp;' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Homepage</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row">' +
					'<div class="column full center">' +
						...
						'\n<div style="margin: 3em 0">' +
							_tabs(1) + '<a href="#" class="is-btn is-btn-ghost2 is-upper is-btn-small">Contact Us</a> &nbsp;' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Notify Me</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full center">' +
						'<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current rounded-full">Notify Me</a>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<div class="center"><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Notify Me</a></div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				`<div style="max-width: 420px; margin: 0 auto;">
					...
					<div style="margin: 25px 0; text-align: center;"><a href="#" title="" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 rounded font-normal hover:text-white hover:border-transparent text-white uppercase tracking-125 bg-emerald-400 hover:bg-emerald-500 size-13 py-2 px-6">Notify Me</a></div>
				</div>`
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row">' +
					'<div class="column full">' +
						'<div class="center">' +
							_tabs(1) + '<a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded text-black tracking-75 font-normal uppercase py-2 size-14 px-8 border-current hover:border-current">Drop us a line</a>' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600">Read More</a><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600">Read More</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600">Read More</a><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded tracking-75 uppercase py-2 size-14 px-8 border-current hover:text-white hover:border-transparent font-semibold text-indigo-500 hover:bg-indigo-500">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600">Read More</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 rounded tracking-75 uppercase py-2 size-14 px-8 border-current hover:text-white hover:border-transparent font-semibold text-indigo-500 hover:bg-indigo-500">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600 rounded-full">Read More</a><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold rounded-full">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 size-16 tracking-75 uppercase py-3 px-11 font-semibold text-gray-600 rounded-full">Read More</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 size-16 tracking-75 uppercase py-3 px-11 border-current text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-transparent font-semibold rounded-full">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600 rounded-full">Read More</a><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid ml-1 mr-1 uppercase py-2 size-14 px-8 border-current hover:text-white hover:border-transparent font-semibold text-indigo-500 hover:bg-indigo-500 tracking-75 rounded-full">Buy Now</a></div>`
		},

		{
		    ...
		    'category': '119',
		    'html':
				`<div><a href="#" role="button" class="transition-all inline-block cursor-pointer no-underline border-2 border-solid border-transparent ml-1 mr-1 hover:border-transparent bg-gray-200 hover:bg-gray-300 tracking-75 uppercase py-2 size-14 px-8 font-semibold text-gray-600 rounded-full">Read More</a></div>`
		},
        ...
        */
		...
		// CONTACT FORM
		{
			'thumbnail': 'preview/contact-form1.png',
		    'category': '116',
			'html':
				'<div class="row">' +
					'<div class="column full" data-noedit data-html="' + 
						encodeURIComponent(`
							...
							<div>
								<label for="emailk{id}">Email:</label>
								<div class="mt-1">
									<input class="w-full px-2 py-3 text-base border rounded" type="email" id="emailk{id}" name="email" required="">
								</div>
							</div>
							<div>
								<label for="messagek{id}">Message:</label>
								<div class="mt-1">
									<textarea class="w-full px-2 py-3 text-base border rounded" rows="6" id="messagek{id}" name="message" required=""></textarea>
								</div>
							</div>
        ...
        {
			'thumbnail': 'preview/contact-form2.png',
		    'category': '116',
			'html':
				'<div class="row">' +
					'<div class="column full" data-noedit data-html="' + 
						encodeURIComponent(`
							<form class="formk{id} mt-6 space-y-6 px-1" method="POST" action="">
							<div>
								<label for="namek{id}">Name:</label>
								<div class="mt-1">
									<input class="w-full px-2 py-3 text-base border rounded" type="text" id="namek{id}" name="name" required="">
								</div>
							</div>
							<div>
								<label for="emailk{id}">Email:</label>
        ...
        {
			'thumbnail': 'preview/contact-form3.png',
		    'category': '116',
			'html':
				'<div class="row">' +
					'<div class="column full" data-noedit data-html="' + 
						encodeURIComponent(`
							<form class="form{id} mt-6 space-y-6 px-1" method="POST" action="">
								...
								<div class="captchaWidget flex justify-center"></div>
								<div class="flex justify-center is-subblock" data-subblock>
									<button class="transition-all inline-block cursor-pointer border-2 border-solid border-transparent hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 py-3 size-17 px-8 font-semibold text-gray-600 leading-relaxed" type="submit">Send</button>
								</div>
							</form>
						`) +
						'" data-settings="">' +
				...
				'<div class="row">' +
					'<div class="column full" data-noedit data-html="' + 
						...
						encodeURIComponent(
							...
							.success{id}.collapsed {
								height: 0;
							}
							</style>
								<div>
								<form class="form{id} mt-6 space-y-6 px-1" method="POST">
									<div>
										<label for="email{id}">Email:</label>
										<div class='mt-1'>
											<input class="w-full px-2 py-3 text-base border rounded" type="email" id="email{id}" name="email" required />
									...
									<div class="captchaWidget"></div>
									<div class="flex justify-center">
											<button class="w-full flex justify-center items-center transition-all cursor-pointer border-2 border-solid border-transparent hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 py-3 size-17 px-8 font-semibold text-gray-600 leading-relaxed" type="submit">Submit</button>
									</div>
								</form>
								<div class="success{id} collapsed text-xl">
								...
								docReady(function() {
									...
									var frm = document.querySelector('.form{id}');
									...
									loadScriptByURL('recaptcha-key', 'https://www.google.com/recaptcha/api.js', function () {
										...
										setTimeout(function(){
											...
											var frm = document.querySelector('.form{id}');
											captchaWidget{id} = grecaptcha.render(frm.querySelector('.captchaWidget'), {
							...
							.success{id}.collapsed {
								...
								docReady(function() {
									...
									frm.onsubmit = function() {
										...
										var inpEmail = frm.querySelector('#email{id}');
										var inpMessage = frm.querySelector('#message{id}');
										const reqBody = { name: inpName.value, email: inpEmail.value, message: inpMessage.value, token: token };
										fetch('/api/contact', {
											method:'POST',
											body: JSON.stringify(reqBody),
											header: {
							...
							encodeURIComponent(
								...
								.success{id}.collapsed {
									...
									<form class="form{id} mt-6 space-y-6 px-1" method="POST">
										...
										<div class="captchaWidget flex justify-center"></div>
										<div class="flex justify-center is-subblock" data-subblock>
												<button class="transition-all inline-block cursor-pointer border-2 border-solid border-transparent hover:border-transparent rounded bg-gray-200 hover:bg-gray-300 py-3 size-17 px-8 font-semibold text-gray-600 leading-relaxed" type="submit">Submit</button>
										</div>
									</form>
									<div class="success{id} collapsed text-xl">
										Thank You! Your Message Has Been Sent Successfully.
        ...
        'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<p><i style="color: rgb(136, 136, 136);">"Lorem Ipsum is dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s."  — James Chapman </i></p>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem ipsum dolor amet, consectetur adipiscing elit. Vivamus leo ante.</p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s. Lorem ipsum dolor sit amet.</p>' +
					'</div>' +
					'<div class="column half">' +
						'<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s. Lorem ipsum dolor sit amet.</p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'<div class="column half">' +
						'<div class="padding-20">' +
							_tabs(1) + '<p style="text-align: justify; color: rgb(136, 136, 136);"><i style="color: rgb(136, 136, 136);">"Lorem Ipsum is simply dummy text of the printing industry."</i></p>' +
							_tabs(1) + '<div class="spacer height-20"></div>' +
							_tabs(1) + '<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus leo ante, consectetur sit amet vulputate vel.</p>' +
						'\n</div>' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Vivamus leo ante, consectetur amet vulputate vel, dapibus amet.</p>' +
					'</div>' +
					'<div class="column half">' +
						'<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Vivamus leo ante, consectetur amet vulputate vel, dapibus amet.</p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>' +
						'\n<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem ipsum dolor sit amet, consectetur elit. Vivamus leo ante, consectetur sit amet.</p>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<p class="size-21"><i>"Lorem Ipsum is simply dummy text of the printing industry."</i></p>' +
						'\n<p style="border-bottom: 2px solid #f57213;width: 130px;display: inline-block;margin-top: 5px;"></p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<p style="text-align: justify;">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus leo ante.</p>' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						...
						'\n<br>' +
						'\n<p style="width: 100%; max-width: 500px; margin: 0px auto; text-align: justify;">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-42" style="letter-spacing: 5px;">MEET THE TEAM</h1>' +
						'\n<p style="color: rgb(136, 136, 136);">Here are our awesome team</p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					...
					'<div class="column half">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:30px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<div class="is-social edit" style="margin:1em 0">' +
									'<a href="https://twitter.com/"><i class="icon ion-social-twitter" style="margin-right: 1em"></i></a>' +
									'<a href="https://www.facebook.com/"><i class="icon ion-social-facebook" style="margin-right: 1em"></i></a>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-42" style="letter-spacing: 2px;">MEET OUR TEAM</h1>' +
						'\n<p style="border-bottom: 2px solid #e74c3c; width: 60px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
            ...
            'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						...
						'\n<h1 class="size-80" style="letter-spacing: 5px; font-style: normal;">New Arrival</h1>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<h1 class="size-42" style="letter-spacing: 2px;">SPECIAL FEATURES</h1>' +
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<i class="icon ion-ios-settings size-42"></i>' +
						'\n<h3 class="size-24">FEATURE ITEM</h3>' +
						'\n<p>Lorem Ipsum is dummy text of the printing industry.</p>' +
					'</div>' +
					'<div class="column third">' +
		...
		
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #000;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-bulb size-24" style="color: #fff;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Feature Item</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #000;text-align:center">' +
								_tabs(2) + '<i class="icon ion-compose size-24" style="color: #fff;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Feature Item</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #000;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-options size-24" style="color: #fff;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Feature Item</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					...
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #000;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-microphone size-24" style="color: #fff;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Feature Item</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						...
						'\n<p class="size-16" style="margin-top: 0px;">200k+ CLIENTS</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<i class="icon ion-android-clipboard size-64" style="margin-bottom:0"></i>' +
						'\n<p class="size-16" style="margin-top: 0px;">99 PROJECTS DONE</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<i class="icon ion-trophy size-64" style="margin-bottom:0"></i>' +
						'\n<p class="size-16" style="margin-top: 0px;">17 AWARDS WON</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<i class="icon ion-android-favorite-outline size-64" style="margin-bottom:0"></i>' +
						'\n<p class="size-16" style="margin-top: 0px;">500K+ FOLLOWERS</p>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div class="is-card max-390 is-dark-text" style="width:calc(100%);background-color: #f9f9f9;">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-48" style="letter-spacing: 9px;">TESTIMONIALS</h1>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full center">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-42">CUSTOMER TESTIMONIALS</h1>' +
						'\n<p>Hear the interesting stories from our lovely customers.</p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-42">TESTIMONIALS</h1>' +
						'\n<p>Hear the interesting stories from our lovely customers.</p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<h1 class="size-42" style="text-align: center; letter-spacing: 4px;">THE PROCESS</h1>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<i class="icon ion-edit size-48"></i>' +
						'\n<h3>STEP 2</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
					'</div>' +
				'</div>' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<h1 class="size-50" style="letter-spacing: 2px; text-align: center;">Ready to Purchase?</h1>' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-50" style="letter-spacing: 2px;">PRICING PLANS</h1>' +
						'\n<p>Choose the right plan that works for you.</p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<h3 style="letter-spacing: 3px;">BASIC</h3>' +
								_tabs(2) + '<div class="display">' +
									_tabs(3) + '<h1>$<span class="size-76">29</span></h1>' +
								_tabs(2) + '</div>' +
								...
								_tabs(2) + '</ul>' +
								_tabs(2) + '<div style="margin: 15px 0"><a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small">Get Started</a></div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<h3 style="letter-spacing: 3px;">PRO</h3>' +
								_tabs(2) + '<div class="display">' +
									_tabs(3) + '<h1>$<span class="size-76">59</span></h1>' +
								_tabs(2) + '</div>' +
								_tabs(2) + '<ul style="text-align:left">' +
									_tabs(3) + '<li>Lorem Ipsum is simply text of the printing.</li>' +
									_tabs(3) + '<li>Lorem ipsum dolor sit amet, consectetur adipiscing.</li>' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-48" style="letter-spacing: 3px;">PRICING PLANS</h1>' +
						'\n<p style="border-bottom: 2px solid #000; width: 80px; display: inline-block;"></p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					...
					'<div class="column third">' +
						'<figure class="snip1361">' +
							...
							_tabs(1) + '<figcaption>' +
								...
								_tabs(2) + '<p style="line-height: 1.2;">Lorem Ipsum is simply dummy text of the printing industry.</p>' +
							_tabs(1) + '</figcaption>' +
						'\n</figure>' +
					'</div>' +
					'<div class="column third">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<figure class="snip1361">' +
							_tabs(1) + '<a href="#"><img src="assets/minimalist-blocks/images/natalia-y-339470-unsplash-oW9JY1.jpg" alt=""></a>' +
							_tabs(1) + '<figcaption>' +
								_tabs(2) + '<h3 style="line-height: 1.8;">Image Caption</h3>' +
								_tabs(2) + '<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
							_tabs(1) + '</figcaption>' +
						'\n</figure>' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-48" style="letter-spacing: 4px; margin-top: 0px; line-height: 1;">OUR PORTFOLIO</h1>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix" style="padding: 0;">' +
					'<div class="column third" style="position: relative; display: flex; flex-direction: column; justify-content: flex-start; align-items: flex-end;">' +
						'<div class="display margin-right-1024-reset" style="z-index:1;text-shadow: rgba(0, 0, 0, 0.15) 0px 15px 50px;margin-right: -80px;margin-top: 40px;">' +
							'<h1 class="size-38" style="text-align: right; letter-spacing: 1px;">Less stuff, more meaning</h1>' +
				...
				'<div class="row clearfix" style="padding: 0;">' +
					...
					'<div class="column third" style="position: relative;">' +
						'<div class="display margin-left-1024-reset" style="text-shadow: rgba(0, 0, 0, 0.15) 0px 15px 50px; margin-left: -80px; margin-top: 40px;">' +
							'<h1 class="size-38">Less stuff, more meaning</h1>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-42" style="letter-spacing: 5px;">OUR TEAM</h1>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
				...
				'</div>' +
				'<div class="row clearfix" style="padding: 0;">' +
					'<div class="column third" style="padding: 0;display:flex;">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
					...
					'</div>' +
					'<div class="column third" style="padding: 0;display:flex;">' +
						'<div class="is-card is-dark-text shadow-1" style="z-index:1;width:calc(100%);transform: scale(1.08);border-top: 3px solid #fb6907;">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-42" style="letter-spacing: 4px;">SERVICES WE PROVIDE</h1>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #e6e6e6;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-create size-24" style="color: #5f5f5f;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Service One</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #e6e6e6;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-desktop size-24" style="color: #5f5f5f;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Service Two</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #e6e6e6;text-align:center">' +
								_tabs(2) + '<i class="icon ion-code size-24" style="color: #5f5f5f;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Service Three</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="display: flex;justify-content: center;align-items: center;position: absolute; top:4px; border-radius: 500px; width: 50px; height: 50px; background: #e6e6e6;text-align:center">' +
								_tabs(2) + '<i class="icon ion-earth size-24" style="color: #5f5f5f;line-height:50px;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Service Four</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
				'</div>'
...

        {
            ...
            'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="position: absolute; width: 50px; height: 50px; background: #00cab8;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-favorite-outline size-24" style="color: #ffffff;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Creative Designs</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="position: absolute; width: 50px; height: 50px; background: #00cab8;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-create size-24" style="color: #ffffff;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Web Development</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="position: absolute; width: 50px; height: 50px; background: #00cab8;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-globe size-24" style="color: #ffffff;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Brand Building</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list larger">' +
							_tabs(1) + '<div style="position: absolute; width: 50px; height: 50px; background: #00cab8;text-align:center">' +
								_tabs(2) + '<i class="icon ion-android-chat size-24" style="color: #ffffff;"></i>' +
							_tabs(1) + '</div>' +
							_tabs(1) + '<h2 class="size-24" style="margin: 0 0 0 70px">Support</h2>' +
							_tabs(1) + '<p style="margin: 10px 0 0 70px">Lorem Ipsum is dummy text of the printing industry.</p>' +
						'\n</div>' +
					'</div>' +
				'</div>'
...

        {
            ...
            'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<p style="letter-spacing: 4px;">DISCOVER WHAT\'S NEW</p>' +
						'\n<h1 class="size-60" style="letter-spacing: 5px; font-style: normal;">OUR MENU</h1>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
...

        {
            ...
            'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<p style="letter-spacing: 4px;">DISCOVER WHAT\'S NEW</p>' +
						'\n<h1 class="size-60" style="letter-spacing: 5px; font-style: normal;">OUR PRODUCTS</h1>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full" data-noedit="" data-html="' +
				...
				'<div class="row clearfix">' +
					'<div class="column center half">' +
						'<div class="servicebox">' +
							...
							_tabs(1) + '<h3 class="title size-24" style="letter-spacing: 1px;">Web Design</h3>' +
					...
					'<div class="column center half">' +
						'<div class="servicebox">' +
							...
							_tabs(1) + '<h3 class="title size-24" style="letter-spacing: 1px;">Web Development</h3>' +
						...
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<ul style="text-align:left">' +
									...
									_tabs(3) + '<li>Lorem Ipsum is dummy text.</li>' +
								_tabs(2) + '</ul>' +
								_tabs(2) + '<div style="margin:1.2em 0"><a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small edit">Select Plan</a></div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third" style="padding: 0;display:flex;">' +
						'<div class="is-card is-light-text shadow-1" style="z-index:1;width: calc(100%);background-color: #2ecc71;transform: scale(1.08)">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
						...
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:30px;width:100%;box-sizing:border-box;text-align:center;">' +
								...
								_tabs(2) + '<ul style="text-align:left">' +
									...
									_tabs(3) + '<li>Lorem Ipsum is dummy text.</li>' +
								_tabs(2) + '</ul>' +
								_tabs(2) + '<div style="margin:1.2em 0"><a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small edit">Buy Now</a></div>' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third" style="padding: 0;display:flex;">' +
						'<div class="is-card is-dark-text shadow-1" style="z-index:1;width:calc(100%);transform: scale(1.08)">' +
							_tabs(1) + '<div style="padding:30px;width:100%;box-sizing:border-box;text-align:center;"">' +
								_tabs(2) + '<h3 class="size-24 is-title-lite">DELUXE</h3>' +
				...
				'<div class="row clearfix">' +
					'<div class="column third" style="padding-right: 30px;">' +
						...
						'\n<ul style="text-align:left">' +
							...
							_tabs(1) + '<li>Lorem Ipsum is simply dummy text.</li>' +
						'\n</ul>' +
						'\n<div style="margin:1.2em 0"><a href="#" class="is-btn is-btn-ghost1 is-upper is-btn-small">Select Plan</a></div>' +
					'</div>' +
					'<div class="column third" style="padding: 0;display:flex;">' +
						'<div class="is-card is-light-text shadow-1" style="z-index:1;width:calc(100%);background-color: #2ecc71;transform: scale(1.08)">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<h1 class="size-48" style="letter-spacing: 2px; text-align: center;">Ready to Purchase?</h1>' +
				...
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half" style="padding: 0;display:flex;">' +
						'<div class="is-card is-light-text shadow-1" style="z-index:1;width:calc(100%);background-color: #f39c12; transform: scale(1.09)">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<h1 class="size-28">Professional</h1>' +
								_tabs(2) + '<h4>$ <span class="size-76">71</span></h4>' +
								_tabs(2) + '<ul style="text-align:left">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 class="size-42" style="letter-spacing: 4px;">WORK EXPERIENCE</h1>' +
						'\n<p style="border-bottom: 2px solid #000;width: 80px;display: inline-block;"></p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
