...
class CampaignActivityMapExt extends ExtensionInit
{
    ...
    public function _showMapView(CAttributeCollection $collection)
    {
        ...
        $controller->renderFile(__DIR__ . '/customer/views/map.php', compact('campaign', 'context', 'model'));
    }
    ...
    public function getAssetsUrl(): string
    {
        ...
        return $assetsUrl = assetManager()->publish(__DIR__ . '/customer/assets', false, -1, MW_DEBUG);
    }
}
