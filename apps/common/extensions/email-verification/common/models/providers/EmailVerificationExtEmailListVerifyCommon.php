...
class EmailVerificationExtEmailListVerifyCommon extends EmailVerificationExtBaseCommon
{
    ...
    public function _emailBlacklistIsEmailBlacklisted($isBlacklisted, string $email, ?ListSubscriber $subscriber = null, ?Customer $customer = null, array $params = [])
    {
        ...
        // Until 2.2.17 - ['fail', 'email_disabled', 'unknown_email', 'domain_error', 'spam_traps', 'syntax_error', 'disposable'];
        // Until 2.6.4 - ['error', 'unknown_email', 'email_disabled', 'domain_error', 'dead_server', 'syntax_error', 'unknown', 'disposable', 'spamtrap'];
        $codes = ['email_disabled', 'dead_server', 'invalid_mx', 'disposable', 'spamtrap', 'invalid_syntax'];
        if (in_array($response, $codes)) {
