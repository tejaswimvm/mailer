...
class TourExt extends ExtensionInit
{
    ...
    public function beforeEnable()
    {
        ...
        $this->runQueriesFromSqlFile(__DIR__ . '/common/data/install.sql');

        // insert default data
        $this->runQueriesFromSqlFile(__DIR__ . '/common/data/insert.sql');
    ...
    public function beforeDisable()
    {
        ...
        $this->runQueriesFromSqlFile(__DIR__ . '/common/data/uninstall.sql');
