 ...
 * @property integer|null|string $customer_id
 * @property integer|null|string $user_id
...
class FavoritePage extends ActiveRecord
{
     ...
     */
    public const BULK_ACTION_RESET_CLICK_COUNT = 'reset-click-count';
    ...
    protected function beforeValidate()
    {
        if (!empty($this->route_params)) {
            $this->route_params = SerializeHelper::serialize($this->route_params);
        } else {
    ...
    protected function afterFind()
    {
        ...
        if (!empty($this->route_params)) {
            $this->route_params = SerializeHelper::unserialize((string)$this->route_params);
        }
    }
}
