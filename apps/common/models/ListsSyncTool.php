...
class ListsSyncTool extends FormModel
{
     ...
     * Actions list
     */
    public const MISSING_SUBSCRIBER_ACTION_NONE              = '';
    public const MISSING_SUBSCRIBER_ACTION_CREATE_SECONDARY  = 'create-secondary';

    /**
     * Actions list
     */
    public const DISTINCT_STATUS_ACTION_NONE               = '';
    public const DISTINCT_STATUS_ACTION_UPDATE_PRIMARY     = 'update-primary';
    public const DISTINCT_STATUS_ACTION_UPDATE_SECONDARY   = 'update-secondary';
    public const DISTINCT_STATUS_ACTION_DELETE_SECONDARY   = 'delete-secondary';

    /**
     * Actions list
     */
    public const DUPLICATE_SUBSCRIBER_ACTION_NONE              = '';
    public const DUPLICATE_SUBSCRIBER_ACTION_DELETE_SECONDARY  = 'delete-secondary';
