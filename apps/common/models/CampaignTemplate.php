...
class CampaignTemplate extends ActiveRecord
{
    ...
    public function getAvailableTags(): array
    {
        $tags = [
            ...
            ['tag' => '[CAMPAIGN_TEMPLATE_NAME]', 'required' => false],
            ...
            ['tag' => sprintf('[COUNTDOWN until=\'%s\' size=\'large\' text-color=\'db9842\' background-color=\'ffffff\' show-circle=\'yes\' circle-background-color=\'ffcccc\' circle-foreground-color=\'ff0000\' max-frames=60 show-text-label=\'yes\']', date('Y-m-d H:i:s', strtotime('+12 hours'))), 'required' => false],
     ...
     * @throws CException
     */
    public function getContentUrls(?CAttributeCollection $context = null): array
    {
        $urls = CampaignHelper::extractTemplateUrls($this->content, $context);

        return array_filter($urls, [CampaignHelper::class, 'validateCampaignTemplateActionLinkUrl']);
    }
