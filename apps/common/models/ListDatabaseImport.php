...
class ListDatabaseImport extends ListImportAbstract
{
     ...
     * Server type flags
     */
    public const SERVER_TYPE_MYSQL = 'mysql';
    public const SERVER_TYPE_POSTGRESQL = 'pgsql';
    public const SERVER_TYPE_SQLSERVER = 'mssql';
    public const SERVER_TYPE_ORACLE = 'oci';
