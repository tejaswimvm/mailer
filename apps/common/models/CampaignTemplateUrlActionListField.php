...
class CampaignTemplateUrlActionListField extends ActiveRecord
{
    ...
    public function getCustomFieldsAsDropDownOptions(): array
    {
        ...
        $typeIds   = [];
        $typeNames = (array)hooks()->applyFilters('campaign_click_action_allowed_fields', (array)app_param('campaign.click_action.allowed_fields', []));
    ...
    public function _validateUrl(string $attribute, array $params = []): void
    {
        ...
        if (CampaignHelper::validateCampaignTemplateActionLinkUrl($this->$attribute)) {
            return;
        }
