...
class OptionCommon extends OptionBase
{
    ...
    public function rules()
    {
        $rules = [
            ...
            ['ga_version', 'in', 'range' => array_keys($this->getGaVersionsList())],
    ...
    public function attributeHelpTexts()
    {
        $texts = [
            ...
            'ga_version'            => $this->t('The version of GA your tracking code is meant for.'),
     ...
     * @return array
     */
    public function getGaVersionsList(): array
    {
        return [
            3   => $this->t('Version {n}', ['{n}' => 3]),
            4   => $this->t('Version {n}', ['{n}' => 4]),
        ];
    }
     ...
     * @return int
     */
    public function getGaVersion(): int
    {
        return (int)$this->ga_version;
    }
