...
class OptionCronProcessFeedbackLoopServers extends OptionBase
{
     ...
     * Action flags
     */
    public const ACTION_DELETE_SUBSCRIBER = 'delete';
    public const ACTION_UNSUBSCRIBE_SUBSCRIBER = 'unsubscribe';
    public const ACTION_BLACKLIST_SUBSCRIBER = 'blacklist';
    ...
    public function takeActionAgainstSubscriberWithCampaign(ListSubscriber $subscriber, Campaign $campaign): void
    {
        ...
        if ($this->getSubscriberActionIsBlacklist()) {
            if (!empty($campaign->customer) && $campaign->customer->getGroupOption('lists.can_use_own_blacklist', 'no') == 'yes') {
