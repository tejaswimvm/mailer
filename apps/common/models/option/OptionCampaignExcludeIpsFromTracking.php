...
class OptionCampaignExcludeIpsFromTracking extends OptionBase
{
    ...
    {
        $placeholders = [
            'open' => '11.11.11.11, 22.22.22.22, 33.33.33.33, 10.0.0.0/16',
            'url'  => '11.11.11.11, 22.22.22.22, 33.33.33.33, 10.0.0.0/16',
        ];
    ...
    {
        $texts = [
            'open' => $this->t('IPs list, separated by a comma, to exclude from open tracking. IP ranges accepted'),
            'url'  => $this->t('IPs list, separated by a comma, to exclude from url tracking. IP ranges accepted'),
        ];
