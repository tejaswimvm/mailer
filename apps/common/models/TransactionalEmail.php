...
class TransactionalEmail extends ActiveRecord
{
    ...
    public function send(): bool
    {
        ...
        $sent = $server->setDeliveryFor(DeliveryServer::DELIVERY_FOR_TRANSACTIONAL)->setDeliveryObject($this)->send($emailParams);
        if ($sent) {
    ...
    public function getStatusesList(): array
    {
        return [
            ...
            self::STATUS_FAILED => t('transactional_emails', ucfirst(self::STATUS_FAILED)),
        ];
    }
