...
class StartPage extends ActiveRecord
{
    ...
    {
        $url     = apps()->getBaseUrl('assets/css/font-awesome/css/font-awesome.min.css', true);
    ...
    {
        $url     = apps()->getBaseUrl('assets/css/ionicons/css/ionicons.min.css', true);
    ...
    {
        $url     =  apps()->getBaseUrl('assets/css/bootstrap.min.css', true);
    ...
    public function getIconsFromUrlByPattern(string $url, string $pattern): array
    {
        ...
        $icons = array_map('html_encode', array_map('strval', $icons));
