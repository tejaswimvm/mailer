 ...
 * @property string $max_responder_responses
...
class Survey extends ActiveRecord
{
    ...
    {
        $rules = [
            ['name, status, max_responder_responses', 'required'],
            ['customer_id', 'numerical', 'integerOnly' => true],
            ['category_id', 'exist', 'className' => SurveyCategory::class],
            ...
            ['max_responder_responses', 'numerical', 'integerOnly' => true, 'min' => -1],

            ['survey_id, survey_uid, customer_id, category_id, name, display_name, description, start_at, end_at, status', 'safe', 'on'=>'search'],
        ];
    ...
    public function relations()
    {
        $relations = [
            ...
            'category'            => [self::BELONGS_TO, SurveyCategory::class, 'category_id'],
    ...
    public function attributeLabels()
    {
        $labels = [
            ...
            'max_responder_responses'            => t('surveys', 'Max responder allowed responses'),
    ...
    public function attributeHelpTexts()
    {
        $text = [
            ...
            'max_responder_responses' => t('surveys', 'How many responses a responder is allowed to have. Choose -1 for unlimited. We consider them unique based on their IPs or their subscriber_id'),
        ];
    ...
    public function copy(): ?self
    {
        ...
        try {
            /** @var Survey $survey */
            $survey = $this->createNewInstanceFromLoadedAttributes();
