...
class CampaignOpenActionListField extends ActiveRecord
{
    ...
    public function attributeHelpTexts()
    {
        $texts = [
            ...
            'field_value' => t('campaigns', 'The value that the custom field should get after the subscriber opens the campaign'),
        ];
    ...
    {
        /** @var CampaignOpenActionListField $model */
    ...
    public function getCustomFieldsAsDropDownOptions(): array
    {
        ...
        $typeIds   = [];
        $typeNames = (array)hooks()->applyFilters('campaign_open_action_allowed_fields', (array)app_param('campaign.open_action.allowed_fields', []));
