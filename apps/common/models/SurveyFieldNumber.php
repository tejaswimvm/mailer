...
class SurveyFieldNumber extends SurveyField
{
     ...
     */
    public const VALUE_TYPE_INTEGER_AND_FLOAT = 0;

    /**
     * Flag for integer only
     */
    public const VALUE_TYPE_INTEGER_ONLY = 1;

    /**
     * Scenario for integer and float
     */
    public const SCENARIO_INTEGER_AND_FLOAT = 'integer-and-float';

    /**
     * Scenario for integer only
     */
    public const SCENARIO_INTEGER_ONLY = 'integer-only';
