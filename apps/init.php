...
// download url
defined('MW_WEBSITE_DOWNLOAD_URL') or define('MW_WEBSITE_DOWNLOAD_URL', 'https://www.mailwizz.com/download/');
...
// various constants
define('MW_DATE_NOW', (new DateTime('now', new DateTimeZone('UTC')))->format('Y-m-d'));
define('MW_DATETIME_NOW', (new DateTime('now', new DateTimeZone('UTC')))->format('Y-m-d H:i:s'));
define('MW_CAMPAIGN_TRACK_CLICK_URL_SEGMENT', 'track-url');
define('MW_CAMPAIGN_TRACK_OPEN_URL_SEGMENT', 'track-opening');

define('MW_LANDING_PAGE_TRACK_CLICK_URL_SEGMENT', 'track-url');
...
Yii::$classMap = [
    ...
    'CActiveFinder'   => Yii::getPathOfAlias('common.components.db.ar.CActiveFinder') . '.php',
];
