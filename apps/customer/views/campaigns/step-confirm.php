    ...
    if ($collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            ...
            <div class="box-body">
                ...
                <div class="row campaign-step-confirm-daily-window">
                    <hr />
                    <div class="col-lg-4">
                        <div class="form-group">
				            <?php echo $form->labelEx($campaign, 'send_between_start'); ?>
				            <?php echo $form->dropDownList($campaign, 'send_between_start', CMap::mergeArray(['' => t('app', 'Choose')], $campaign->getSendBetweenHoursList()), $campaign->fieldDecorator->getHtmlOptions('send_between_start', ['class' => 'form-control select2', 'style' => 'width: 100%'])); ?>
				            <?php echo $form->error($campaign, 'send_between_start'); ?>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <div class="clearfix"><!-- --></div>
                            <a href="#send-between-page-info" class="btn btn-primary btn-flat no-spin" data-toggle="modal"><?php echo IconHelper::make('info'); ?></a>
                            <a href="javascript:" class="btn btn-danger btn-send-between-reset-selection"><?php echo t('campaigns', 'Reset selection'); ?></a>
                        </div>
                    </div>
                    <div class="modal modal-info fade" id="send-between-page-info" tabindex="-1" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
					                <?php echo $campaign->t('Optionally, this campaign can send each day, starting with the selected hour, for the given interval of time, using your account timezone.'); ?>
                                    <br /><br />
	                                <?php echo $campaign->t('Please note that using this option will result in much slower delivery as a campaign sending can span multiple days.'); ?><br />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    ...
                    $controller->widget('zii.widgets.CDetailView', [
                        ...
                        'attributes'    => [
                            ...
                            [
                                'label'   => t('campaigns', 'Subject blacklisted words'),
                                'value'   => implode(', ', $campaign->getSubjectBlacklistWords()),
                                'visible' => $campaign->getSubjectBlacklistWords(),
                            ],
                            [
                                'label'   => t('campaigns', 'Body blacklisted words'),
                                'value'   => implode(', ', $campaign->getContentBlacklistWords()),
                                'visible' => $campaign->getContentBlacklistWords(),
                            ],
                            [
                            ...
                            [
                                ...
                                'type'    => 'raw',
                                'value'   => $campaign->getAttachmentsDownloadLinks(),
                                'visible' => $campaign->getAttachmentsDownloadLinks(),
                            ],
                            [
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <button type="submit" id="is_next" name="is_next" value="1" class="btn btn-primary btn-flat btn-go-next">
						                <?php echo $campaign->getIsAutoresponder() ? t('campaigns', 'Save and activate') : t('campaigns', 'Schedule campaign'); ?>
                                    </button>
                                </li>
