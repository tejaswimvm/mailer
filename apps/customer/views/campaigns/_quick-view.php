        ...
        <div class="list-wrapper">
            ...
            <ul class="custom-list">
	            ...
	            <?php if ($campaign->getIsRegular()) { ?>
                    ...
                    <li><span class="cl-span"><?php echo $campaign->getAttributeLabel('started_at'); ?></span><span class="cl-span"><?php echo $campaign->getStartedAt() ?: $campaign->getSendAt(); ?></span></li>
	            ...
	            <?php if ($campaign->getIsAutoresponder()) { ?>
		            ...
		            <?php if (!empty($campaign->option->autoresponder_sent_campaign_id)) { ?>
                        <li><span class="cl-span"><?php echo t('campaigns', 'After campaign sent'); ?></span><span class="cl-span"><?php echo CHtml::link($campaign->option->autoresponderSentCampaign->name, ['campaigns/overview', 'campaign_uid' => $campaign->option->autoresponderSentCampaign->campaign_uid], ['target' => '_blank']); ?></span></li>
		            <?php } elseif (!empty($campaign->option->autoresponder_open_campaign_id)) { ?>
                        <li><span class="cl-span"><?php echo t('campaigns', 'After campaign open'); ?></span><span class="cl-span"><?php echo CHtml::link($campaign->option->autoresponderOpenCampaign->name, ['campaigns/overview', 'campaign_uid' => $campaign->option->autoresponderOpenCampaign->campaign_uid], ['target' => '_blank']); ?></span></li>
		            <?php } ?>
