...
if ($viewCollection->itemAt('renderContent')) {
        ...
        $controller->widget('zii.widgets.grid.CGridView', hooks()->applyFilters('grid_view_properties', [
            ...
            'columns' => hooks()->applyFilters('grid_view_columns', [
                ...
                [
                    ...
                    'template'          => '{quick-view} {overview} {pause} {unpause} {reset} {copy} {update} {marksent} {resendgiveups}  {archive} {webversion} {delete}',
                ],
            ], $controller),
        ], $controller));
    }
     ...
     * @since 1.7.6
     */
    $controller->renderPartial('_campaign-share-code-import');

    /**
     * Since 2.2.8
     * This creates a modal placeholder to push campaign share code info in.
     */
    $controller->renderPartial('_bulk-campaigns-share-code'); ?>
