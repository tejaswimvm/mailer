    ...
    if ($collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($campaign, 'reply_to', $campaign->fieldDecorator->getHtmlOptions('reply_to')); ?>
                    ...
                    <div class="col-lg-12">
                        <div class="box box-primary borderless" style="margin-bottom:0px;">
                            <div class="box-header">
                                <div class="pull-left">
                                    <h3 class="box-title">
                                        <?php echo IconHelper::make('glyphicon-cog') . t('campaigns', 'Campaign tracking options'); ?>
                                    </h3>
                                </div>
                                <div class="pull-right"></div>
                                <div class="clearfix"><!-- --></div>
                            ...
                            <div class="box-body">
                                <?php
                                // since 1.3.9.0
                                hooks()->doAction('campaign_form_setup_step_before_campaign_tracking_options', [
                                    'controller' => $controller,
                                    'campaign'   => $campaign,
                                    'form'       => $form,
                                ]); ?>
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
			                                <?php echo $form->labelEx($campaign->option, 'open_tracking_from_url_tracking'); ?>
			                                <?php echo $form->dropDownList($campaign->option, 'open_tracking_from_url_tracking', $campaign->option->getYesNoOptions(), $campaign->option->fieldDecorator->getHtmlOptions('open_tracking_from_url_tracking')); ?>
			                                <?php echo $form->error($campaign->option, 'open_tracking_from_url_tracking'); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
				                            <?php echo $form->labelEx($campaign->option, 'open_tracking_exclude_crawlers'); ?>
				                            <?php echo $form->dropDownList($campaign->option, 'open_tracking_exclude_crawlers', $campaign->option->getYesNoOptions(), $campaign->option->fieldDecorator->getHtmlOptions('open_tracking_exclude_crawlers')); ?>
				                            <?php echo $form->error($campaign->option, 'open_tracking_exclude_crawlers'); ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
				                            <?php echo $form->labelEx($campaign->option, 'url_tracking_exclude_crawlers'); ?>
				                            <?php echo $form->dropDownList($campaign->option, 'url_tracking_exclude_crawlers', $campaign->option->getYesNoOptions(), $campaign->option->fieldDecorator->getHtmlOptions('url_tracking_exclude_crawlers')); ?>
				                            <?php echo $form->error($campaign->option, 'url_tracking_exclude_crawlers'); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 campaign-smart-tracking-info-wrapper" style="display: none">
                                        <?php $controller->widget('customer.components.web.widgets.campaign-tracking.CampaignSmartTrackingInfoWidget', [
                                            'campaign' => $campaign,
                                        ]); ?>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <?php echo $form->labelEx($campaign->option, 'smart_open_tracking'); ?>
                                            <?php echo $form->dropDownList($campaign->option, 'smart_open_tracking', $campaign->option->getYesNoOptions(), $campaign->option->fieldDecorator->getHtmlOptions('smart_open_tracking')); ?>
                                            <?php echo $form->error($campaign->option, 'smart_open_tracking'); ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <?php echo $form->labelEx($campaign->option, 'smart_click_tracking'); ?>
                                            <?php echo $form->dropDownList($campaign->option, 'smart_click_tracking', $campaign->option->getYesNoOptions(), $campaign->option->fieldDecorator->getHtmlOptions('smart_click_tracking')); ?>
                                            <?php echo $form->error($campaign->option, 'smart_click_tracking'); ?>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                // since 1.3.9.0
                                hooks()->doAction('campaign_form_setup_step_after_campaign_tracking_options', [
                                    'controller' => $controller,
                                    'campaign'   => $campaign,
                                    'form'       => $form,
                                ]); ?>
                ...
                <div class="campaign-ab-test-wrapper">
                    <hr />
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-primary borderless" style="margin-bottom:0px;">
