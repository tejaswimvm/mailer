...
?>
    ...
    <div class="box-footer">
        <div class="pull-right">
            <a href="<?php echo createUrl('sending_domains/verify', ['id' => (int)$domain->domain_id]); ?>" class="btn btn-primary btn-flat"><?php echo IconHelper::make('next') . '&nbsp;' . t('sending_domains', 'Verify DNS records'); ?></a>
        </div>
