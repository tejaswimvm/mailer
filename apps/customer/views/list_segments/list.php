                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                            ...
                            ->addIf(CHtml::link(IconHelper::make('glyphicon-compressed') . t('app', 'Archived segments'), ['list_segments/index', 'list_uid' => $list->list_uid, 'ListSegment[status]' => ListSegment::STATUS_ARCHIVED], ['class' => 'btn btn-primary btn-flat', 'title' => t('list_segments', 'View archived segments')]), !$segment->getIsArchived())
                            ->addIf(CHtml::link(IconHelper::make('glyphicon-list-alt') . t('app', 'All list segments'), ['list_segments/index', 'list_uid' => $list->list_uid], ['class' => 'btn btn-primary btn-flat', 'title' => t('list_segments', 'View all list segments')]), $segment->getIsArchived())
                            ->render(); ?>
                    </div>
                                    ...
                                    [
                                        ...
                                        'buttons'   => [
                                            ...
                                            'archive' => [
                                                ...
                                                'url'       => 'createUrl("list_segments/toggle_archive", array("list_uid" => $data->list->list_uid, "segment_uid" => $data->segment_uid))',
                                                'imageUrl'  => null,
                                        ...
                                        'template'          =>'{copy} {update} {archive} {unarchive} {confirm_delete}',
                                    ],
                                ], $controller),
                            ], $controller));
    }
