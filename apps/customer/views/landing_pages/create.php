...
if ($viewCollection->itemAt('renderContent')) {
    ...
    if ($collection->itemAt('renderForm')) {
        ...
        echo $form->hiddenField($revision, 'template_id'); ?>
        <div class="box box-primary borderless">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <?php $controller->widget('customer.components.web.widgets.landing-pages.LandingPageTemplatesGridWidget'); ?>
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <?php echo $form->textField($revision, 'title', $revision->fieldDecorator->getHtmlOptions('title')); ?>
                        ...
                        <div class="row landing-page-template-preview-container">
                            <div class="col-lg-12">
                                <img class="landing-page-template-preview-image" src="" width="100%" height="100%" style="display: none" alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-footer">
                <div class="pull-right">
                    <button type="submit" class="btn btn-primary btn-flat"><?php echo IconHelper::make('next') . t('app', 'Next'); ?></button>
                </div>
                <div class="clearfix"><!-- --></div>
            </div>
        </div>
