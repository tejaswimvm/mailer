    ...
    <div class="box-header">
        <div class="pull-left">
	        <?php BoxHeaderContent::make(BoxHeaderContent::LEFT)
	            ->add('<h3 class="box-title">' . IconHelper::make('fa-sitemap') . t('app', 'Subscribers opens info based on user agent') . '</h3>')
	            ->render();
?>
        </div>
    ...
    <div class="box-body campaign-devices-wrapper">
        <div class="row">
            <div class="col-lg-4">
                <h5><?php echo t('campaigns', 'Operating systems'); ?></h5>
                <hr />
            ...
            <div class="col-lg-4">
                <h5><?php echo t('campaigns', 'Devices'); ?></h5>
                <hr />
                <div style="max-height: 200px;overflow-y: scroll;">
            ...
            <div class="col-lg-4">
                <h5><?php echo t('campaigns', 'Browsers'); ?></h5>
                <hr />
                <div style="max-height: 200px;overflow-y: scroll;">
