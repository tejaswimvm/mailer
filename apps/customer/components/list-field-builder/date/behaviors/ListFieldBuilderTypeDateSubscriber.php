...
/**
 * ListFieldBuilderTypeDateSubscriber
 *
 ...
 */
class ListFieldBuilderTypeDateSubscriber extends ListFieldBuilderTypeSubscriber
{
    /**
    ...
    protected function buildFieldArray(ListFieldValue $model): array
    {
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_date_subscriber_build_field_array', [
            'field'      => $field,
