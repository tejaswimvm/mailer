...
class ListFieldBuilderTypeCheckboxSubscriber extends ListFieldBuilderTypeSubscriber
{
    ...
    protected function getValueModels(): array
    {
        ...
        foreach ($models as $model) {
            ...
            // since 2.2.17
            $model->setDefaultValueParsed((string)ListFieldCheckbox::parseDefaultValueTags((string)$model->default_value, $subscriber));
    ...
    protected function buildFieldArray(ListFieldValue $model): array
    {
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_checkbox_subscriber_build_field_array', [
            'field'      => $field,
