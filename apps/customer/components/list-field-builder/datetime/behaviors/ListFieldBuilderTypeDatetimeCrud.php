...
/**
 * ListFieldBuilderTypeDatetimeCrud
 *
 ...
 */
class ListFieldBuilderTypeDatetimeCrud extends ListFieldBuilderTypeCrud
{
    /**
     * @param CEvent $event
     *
    ...
    public function _addAttributeHelpTexts(CEvent $event)
    {
        ...
        $text = t('list_fields', 'In case this field is not required and you need a default value for it. The format must be "Y-m-d H:i:s". Following tags are recognized: {tags}', ['{tags}' => $tags]);
    ...
    protected function buildFieldArray(ListField $model): array
    {
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_datetime_crud_build_field_array', [
            'field'      => $model,
