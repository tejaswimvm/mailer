...
/**
 * ListFieldBuilderTypeCountryCrud
 *
 ...
 */
class ListFieldBuilderTypeCountryCrud extends ListFieldBuilderTypeCrud
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(ListField $model): array
    {
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_country_crud_build_field_array', [
            'field'      => $model,
