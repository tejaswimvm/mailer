...
/**
 * ListFieldBuilderTypeCountrySubscriber
 *
...
/**
 * @property ListFieldBuilderTypeCountry $owner
 */
class ListFieldBuilderTypeCountrySubscriber extends ListFieldBuilderTypeSubscriber
{
    /**
    ...
    protected function buildFieldArray(ListFieldValue $model): array
    {
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_country_subscriber_build_field_array', [
            'field'      => $field,
