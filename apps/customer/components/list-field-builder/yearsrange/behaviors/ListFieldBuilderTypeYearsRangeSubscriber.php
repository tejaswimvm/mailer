...
/**
 * ListFieldBuilderTypeYearsRangeSubscriber
 *
 ...
 */
class ListFieldBuilderTypeYearsRangeSubscriber extends ListFieldBuilderTypeSubscriber
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(ListFieldValue $model): array
    {
        ...
        /** @var ListFieldBuilderTypeYearsRangeModelSettersGetters $fieldBehavior */
        $fieldBehavior = $this->getListFieldModelSettersGettersBehavior($field);
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_yearsrange_subscriber_build_field_array', [
            'field'      => $field,
     ...
     *
     * @return ListFieldBuilderTypeYearsRangeModelSettersGetters
     */
    protected function getListFieldModelSettersGettersBehavior(ListField $model): ListFieldBuilderTypeYearsRangeModelSettersGetters
    {
        if (!$model->asa('_ListFieldBuilderTypeYearsRangeModelSettersGetters')) {
        ...
        /** @var ListFieldBuilderTypeYearsRangeModelSettersGetters $behavior */
        $behavior = $model->asa('_ListFieldBuilderTypeYearsRangeModelSettersGetters');
