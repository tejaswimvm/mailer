...
/**
 * ListFieldBuilderTypeGeostateSubscriber
 *
...
/**
 * @property ListFieldBuilderTypeGeostate $owner
 */
class ListFieldBuilderTypeGeostateSubscriber extends ListFieldBuilderTypeSubscriber
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(ListFieldValue $model): array
    {
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_geostate_subscriber_build_field_array', [
            'field'      => $field,
