    ...
    <div class="panel panel-default no-top-border">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="form-group">
			            <?php echo CHtml::activeLabelEx($model, 'default_country'); ?>
			            <?php echo CHtml::dropDownList($model->getModelName() . '[' . $fieldType->identifier . '][' . $index . '][default_country]', $model->default_country, $model->getCountriesList(), $model->getHtmlOptions('default_country', ['data-placement' => 'left'])); ?>
			            <?php echo CHtml::error($model, 'default_country'); ?>
                    </div>
                </div>
            </div>
        </div>
