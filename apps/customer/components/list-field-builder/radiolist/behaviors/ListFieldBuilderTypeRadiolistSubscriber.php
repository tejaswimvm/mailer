...
/**
 * ListFieldBuilderTypeRadiolistSubscriber
 *
 ...
 */
class ListFieldBuilderTypeRadiolistSubscriber extends ListFieldBuilderTypeSubscriber
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(ListFieldValue $model): array
    {
        ...
        return (array)hooks()->applyFilters('list_field_builder_type_radiolist_subscriber_build_field_array', [
            'field'      => $field,
