...
/**
 * SurveyFieldBuilderTypeGeocityResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeGeocity $owner
 */
class SurveyFieldBuilderTypeGeocityResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    public function _setCorrectValidationRules(CModelEvent $event)
    {
        ...
        $rules->add(['value', 'length', 'max' => (int) hooks()->applyFilters('surveyfieldvalue_model_value_max_length', 255)]);
    }
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return (array)hooks()->applyFilters('survey_field_builder_type_email_responder_build_field_array', [
