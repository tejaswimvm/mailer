...
/**
 * SurveyFieldBuilderTypeDatetimeCrud
 *
 ...
 */
class SurveyFieldBuilderTypeDatetimeCrud extends SurveyFieldBuilderTypeCrud
{
    /**
     * @param CEvent $event
     *
    ...
    {
        $text = t('survey_fields', 'In case this field is not required and you need a default value for it. The format must be "Y-m-d H:i:s".');
