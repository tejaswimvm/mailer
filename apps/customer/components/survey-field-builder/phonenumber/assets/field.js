jQuery(document).ready(function($){
	...
	// delete field button.
	$(document).on('click', 'a.btn-remove-phonenumber-field', function(){
	...
	// add
	$('a.btn-add-phonenumber-field').on('click', function(){
		var currentIndex = -1;
		...
		currentIndex++;
		var tpl = $('#field-phonenumber-javascript-template').html();
