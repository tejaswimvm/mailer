...
class SurveyFieldBuilderTypeGeocountryResponder extends SurveyFieldBuilderTypeResponder
{
    ...
    protected function getValueModels(): array
    {
        ...
        foreach ($models as $model) {
            ...
            $geoCountry = '';
            if ($location = IpLocation::findByIp((string)request()->getUserHostAddress())) {
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return (array)hooks()->applyFilters('survey_field_builder_type_geocountry_responder_build_field_array', [
