    ...
    'components' => [
        ...
        'urlManager' => [
            'rules' => [
                ...
                ['list_segments/toggle_archive', 'pattern' => 'lists/<list_uid:([a-z0-9]+)>/segments/<segment_uid:([a-z0-9]+)>/toggle-archive/*'],
                ['list_segments/toggle_archive', 'pattern' => 'lists/<list_uid:([a-z0-9]+)>/segments/<segment_uid:([a-z0-9]+)>/toggle-archive'],
                ...
                ['campaign_delivery_stats/application', 'pattern' => 'campaigns/application/delivery-stats'],
                ['campaign_delivery_stats/application_export', 'pattern' => 'campaigns/application/delivery-stats/export'],
                ...
                ['campaign_overview_widgets/delivery_stats', 'pattern' => 'campaigns/<campaign_uid:([a-z0-9]+)>/overview-widgets/delivery-stats'],

                ['campaign_overview_widgets/<action>', 'pattern' => 'campaigns/<campaign_uid:([a-z0-9]+)>/overview-widgets/<action:(\w+)>'],

                ['campaign_delivery_stats/campaign', 'pattern' => 'campaigns/<campaign_uid:([a-z0-9]+)>/delivery-stats'],
                ['campaign_delivery_stats/campaign_export', 'pattern' => 'campaigns/<campaign_uid:([a-z0-9]+)>/delivery-stats/export'],
                ...
                ['surveys_categories/<action>', 'pattern' => 'surveys/categories/<action:(\w+)>/*'],
                ['surveys_categories/<action>', 'pattern' => 'surveys/categories/<action:(\w+)>'],
                ...
                ['landing_page_variants/create', 'pattern' => 'landing-pages/variants/<page_id:(.*)>/create'],
                ['landing_page_variants/index', 'pattern' => 'landing-pages/variants/<page_id:(.*)>/index'],

                ['landing_page_variants/toggle_active', 'pattern' => 'landing-pages/variants/<id:(.*)>/toggle-active'],
                ['landing_page_variants/save_attributes', 'pattern' => 'landing-pages/variants/<id:(.*)>/save-attributes'],

                ['landing_page_variants/<action>', 'pattern' => 'landing-pages/variants/<id:(.*)>/<action:(.*)>'],
                ['landing_page_variants/<action>', 'pattern' => 'landing-pages/variants/<action:(.*)>/*'],
                ['landing_page_variants/<action>', 'pattern' => 'landing-pages/variants/<action:(.*)>'],
                ['landing_page_variants', 'pattern' => 'landing-pages/variants'],

                ['landing_page_templates/view', 'pattern' => 'landing-pages/templates/<template_id:([a-z0-9]+)>/view'],

                ['landing_page_domains/<action>', 'pattern' => 'landing-pages/domains/<action:(\w+)>/*'],
                ['landing_page_domains/<action>', 'pattern' => 'landing-pages/domains/<action:(\w+)>'],
                ['landing_page_domains', 'pattern' => 'landing-pages/domains'],

                ['landing_pages/save_domain', 'pattern' => 'landing-pages/<id:(.*)>/save-domain'],

                ['landing_pages/<action>', 'pattern' => 'landing-pages/<id:(.*)>/<action:(.*)>'],
                ['landing_pages/<action>', 'pattern' => 'landing-pages/<action:(.*)>/*'],
                ['landing_pages/<action>', 'pattern' => 'landing-pages/<action:(.*)>'],
                ['landing_pages', 'pattern' => 'landing-pages'],
