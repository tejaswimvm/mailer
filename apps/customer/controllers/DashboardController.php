...
class DashboardController extends Controller
{
     ...
     * @throws CException
     */
    public function actionCampaign_delivery_stats()
    {
        if (!request()->getIsAjaxRequest()) {
            $this->redirect(['dashboard/index']);
            return;
        ...
        $this->renderJson([
            'html' => $this->renderPartial('_campaign-delivery-stats', null, true, true),
        ]);
    }
    ...
    public function getGlanceStats()
    {
        ...
        $criteria->addNotInCondition('t.status', [Lists::STATUS_PENDING_DELETE, Lists::STATUS_ARCHIVED]);
