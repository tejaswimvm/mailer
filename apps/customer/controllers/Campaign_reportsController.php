...
class Campaign_reportsController extends Controller
{
    ...
    public function actionDelivery($campaign_uid)
    {
        ...
        $className = $campaign->getDeliveryLogsArchived() ? CampaignDeliveryLogArchive::class : $campaign->getCampaignDeliveryLogClassName();
        /** @var CampaignDeliveryLog $className */
    ...
    public function loadCampaignModel(string $campaign_uid): Campaign
    {
        ...
        $criteria->compare('t.customer_id', (int)customer()->getId());
        $statuses = [
