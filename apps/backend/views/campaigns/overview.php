...
if ($viewCollection->itemAt('renderContent')) { ?>
    ...
    <div id="campaign-overview-delivery-stats-wrapper" data-url="<?php echo createUrl('campaign_overview_widgets/delivery_stats', ['campaign_uid' => (string)$campaign->campaign_uid]); ?>">
        <div class="box borderless">
            <div class="box-body">
                <div class="row">
                    <div class="ph-item">
