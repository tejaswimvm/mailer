        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $campaign, 'columns' => ['campaign_id', 'campaign_uid', 'customer_id', 'name', 'type', 'group_id', 'send_group_id', 'list_id', 'segment_id', 'search_recurring', 'send_at', 'status', 'started_at', 'search_template_name', 'gridViewDelivered', 'gridViewOpens', 'gridViewClicks', 'gridViewBounces', 'gridViewUnsubs']], true), $itemsCount)
                    ->addIf(CHtml::link(IconHelper::make('glyphicon-compressed') . t('app', 'Archived campaigns'), ['campaigns/archive'], ['class' => 'btn btn-primary btn-flat', 'title' => t('campaigns', 'View archived campaigns')]), !$campaign->getIsArchived())
                        ...
                        [
                            ...
                            'buttons'   => [
                                ...
                                'archive' => [
                                    ...
                                    'visible'   => '$data->getCanBeArchived() && !$data->getIsArchived()',
                                ],
                                'delete' => [
                            ...
                            'template'          => '{quick-view} {overview} {approve} {disapprove} {pause} {unpause} {reset} {block} {unblock} {webversion} {marksent} {resendgiveups} {archive} {delete}',
                        ],
                    ], $controller),
                ], $controller));
    }
