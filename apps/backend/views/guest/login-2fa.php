...
if ($viewCollection->itemAt('renderContent')) {
    ...
    if ($collection->itemAt('renderForm')) {
        ...
        <div class="login-flex">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <?php echo $form->textField($model, 'twofa_code', $model->fieldDecorator->getHtmlOptions('twofa_code', ['autofocus' => 'autofocus'])); ?>
            ...
            <div class="login-billboard login-flex-col" style="background-image: url('<?php echo html_encode((string)$loginBgImage); ?>');">
