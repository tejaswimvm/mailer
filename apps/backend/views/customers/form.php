                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <?php echo $form->dropDownList($customer, 'timezone', $customer->getTimeZonesArray(), $customer->fieldDecorator->getHtmlOptions('timezone', ['class' => 'form-control select2'])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            ...
                            $controller->widget('zii.widgets.jui.CJuiAutoComplete', [
                                'name'          => 'parent',
                                'value'         => !empty($customer->parent) ? ($customer->parent->getFullName() ?: $customer->parent->email) : null,
