...
/** @var bool $showStatusColumn */
$showStatusColumn = $controller->getData('showStatusColumn', true);

$toggleColumnsList = ['to_email', 'to_name', 'reply_to_email', 'reply_to_name', 'from_email', 'from_name', 'subject', 'send_at'];
if ($showStatusColumn) {
    $toggleColumnsList[] = 'status';
}
    ...
    ?>
    		...
    		<div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($controller->widget('common.components.web.widgets.GridViewToggleColumns', ['model' => $email, 'columns' => $toggleColumnsList], true))
                ...
                [
                    ...
                    'buttons'   => [
                        'resend' => [
                            ...
                            'visible'   => 'in_array($data->status, [TransactionalEmail::STATUS_SENT, TransactionalEmail::STATUS_FAILED]) && AccessHelper::hasRouteAccess("transactional_emails/resend")',
                        ],
                        'preview' => [
