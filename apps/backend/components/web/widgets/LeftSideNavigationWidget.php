    ...
    public function getMenuItems(): array
    {
        ...
        $menuItems = [
            ...
            'transactional-emails' => [
                'name'      => t('app', 'Transactional emails'),
                'icon'      => 'glyphicon-envelope',
                'active'    => ['transactional_emails'],
                'route'     => null,
                'items'     => [
                    ['url' => ['transactional_emails/dashboard'], 'label' => t('app', 'Dashboard'), 'active' => strpos($route, 'transactional_emails/dashboard') === 0],
                    ['url' => ['transactional_emails/index'], 'label' => t('app', 'Transactional emails'), 'active' => strpos($route, 'transactional_emails/index') === 0],
                ],
            ],
            'email-templates' => [
            ...
            'misc' => [
                ...
                'icon'      => 'glyphicon-bookmark',
                'active'    => ['misc', 'company_types', 'campaign_abuse_reports', 'campaigns_tracking_ignore_list'],
                'route'     => null,
                'items'     => [
                    ...
                    ['url' => ['campaigns_tracking_ignore_list/index'], 'label' => t('app', 'Campaigns tracking ignore list'), 'active' => strpos($route, 'campaigns_tracking_ignore_list/index') === 0],
